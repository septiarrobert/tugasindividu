			...
			<div class="modal-body">
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama" class="form-control" maxlength="20" type="text" placeholder="Nama" value="<?php echo $a['nama']; ?>" required readonly>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="jeniskelamin" class="form-control" type="text" maxlength="1" placeholder="P/L" value="<?php echo $a['jeniskelamin']; ?>" required readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="no_hp" class="form-control" type="number" placeholder="Nomor HP" value="<?php echo $a['nomor_hp']; ?>" required>
                        </div>
                    </div>
