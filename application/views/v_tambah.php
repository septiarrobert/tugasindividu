		...
		<form action="<?php echo base_url('c_mahasiswa/tambahdata'); ?>" method="POST">
			<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama" class="form-control" maxlength="20" type="text" placeholder="nama" required >
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="jeniskelamin" class="form-control" type="text" maxlength="1" placeholder="P/L" required >
                        </div>
                    </div>
                    <div class="form-group">
